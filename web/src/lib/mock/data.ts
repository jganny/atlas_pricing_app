...
export const MOCK_INBOX: InboxEnquiry[] = [
  {
    ...
    summary: 'New air RFQ BLR→LHR, ~420 kg',
  ...
  },
  {
    ...
    actionRequired: true,
    reason: 'Looks like a rate / quote request',
    summary: 'New FCL RFQ INNSA→NLRTM, 2x40HC',
    classifier: 'heuristic',
    parsed: {
      customer: 'Adani Enterprises',
      origin: 'INNSA',
  ...
  },
  {
    ...
    subject: 'Re: Need air rate — direct sales',
    receivedAt: '2026-09-03T06:05:00Z',
    bodyPreview: 'Any update on BOM–DXB rates for our own cargo?',
    body: '',
    mode: 'air',
    confidence: 55,
    ...
    tag: 'follow_up',
    actionRequired: true,
    reason: 'Reply chasing an existing quote',
    summary: 'Follow-up on BOM–DXB free-hand lane',
    classifier: 'heuristic',
    parsed: {
...
export const MOCK_CIRCULARS: CircularRecord[] = [
  {
    id: 'circ1',
    title: 'EK BOM-DXB Sep tariff',
    carrier: 'Emirates',
    category: 'airline_tariff',
    fileName: 'EK_BOM_DXB_Sep.xlsx',
    notes: 'Valid Sep 2026',
  ...
  {
    id: 'circ2',
    title: 'Fuel surcharge notice — Air',
    carrier: 'IATA',
    category: 'fuel_circular_airline',
    fileName: 'fuel_sep.pdf',
    notes: '',
    createdAt: '2026-09-02T10:00:00Z',
  },
  {
    id: 'circ3',
    title: 'Maersk India THC update',
    carrier: 'Maersk',
    category: 'line_circular',
    fileName: 'maersk_thc.pdf',
...
export const MOCK_LEADS: SalesLead[] = [
  {
    ...
    email: 'priya@adani.example',
    phone: '+91 98765 10001',
    status: 'quoted',
    mode: 'sea',
    lane: 'INNSA → NLRTM',
    dealValue: 420000,
    nextAction: 'Send revised FCL offer',
  ...
  {
    id: 'lead5',
    company: 'Gulf Importers LLC',
    contactName: 'Omar',
    status: 'lost',
    mode: 'sea',
    lane: 'INNSA → Jebel Ali',
    dealValue: 200000,
    winLossReason: 'Rate too high vs competitor',
    owner: 'shaheer',
...
export const MOCK_ACTIVITIES: LeadActivity[] = [
  {
    ...
    leadId: 'lead1',
    type: 'note',
    body: 'Customer asked for 40HC options with THC separate.',
    createdBy: 'shaheer',
  ...
  },
  {
    ...
    leadId: 'lead1',
    type: 'email',
    body: 'Sent draft FCL quotation AE-2401.',
    createdBy: 'shaheer',
  ...
  },
  {
    ...
    leadId: 'lead2',
    type: 'call',
    body: 'Intro call — needs urgent BOM-DXB air capacity.',
    createdBy: 'shashank',
    createdAt: '2026-09-03T15:00:00Z',
  },
]

export const MOCK_CREDIT: CreditControl[] = [
  {
  ...
  },
  {
    ...
    hasAgreement: false,
    blocked: false,
    notes: 'New free-hand account',
  },
  {
    id: 'gulf_importers_llc',
    customer: 'Gulf Importers LLC',
    creditDays: 30,
    creditLimit: 100000,
    hasAgreement: true,
    blocked: true,
    notes: 'Overdue — block new nominations',
  },
]
