...
export const parityGroups: ParityGroup[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { id: "dir-excel", name: "Excel import / export", legacy: "Directory", status: "partial" },
      { id: "dir-agency", name: "Agent agreement file per contact", legacy: "Directory", status: "partial" },
