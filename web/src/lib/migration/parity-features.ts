...
export const parityGroups: ParityGroup[] = [
  {
    ...
    features: [
      ...
      { id: "auth-admin-register", name: "Admin register new user", legacy: "Admin console", status: "partial" },
  ...
  },
  {
    ...
    features: [
      ...
      { id: "home-kpi", name: "Admin KPI rings (revenue, conversions, rate)", legacy: "Overview", status: "partial" },
      ...
      { id: "dash-basic", name: "Basic SLA dashboard", legacy: "Member/admin home", react: "/", status: "done", testHint: "Open counts only — not full manager panel" },
    ],
  },
  {
    id: "member-desk",
  ...
  },
  {
    ...
    features: [
      ...
      { id: "air-preview", name: "Official quote preview / print / PDF", legacy: "Air desk", react: "/air", status: "partial", testHint: "Save & preview opens modal; full legacy PDF layout still Phase 7 polish" },
  ...
  },
  {
    ...
    features: [
      ...
      { id: "sea-preview", name: "Official quote preview / print / PDF", legacy: "Sea desk", react: "/sea", status: "partial", testHint: "Save & preview opens modal; full legacy PDF still pending" },
  ...
  },
  {
    ...
    features: [
      ...
      { id: "edb-advanced-filters", name: "Advanced filters + column picker", legacy: "Enquiry DB", status: "missing", testHint: "Phase 9b — mode/desk filters ship now; full chip suite later" },
      ...
      { id: "edb-actions", name: "Duplicate, cancel, lost, delete row actions", legacy: "Enquiry DB", react: "/enquiries", status: "partial", testHint: "Won/lost/cancel/delete/duplicate — transport/warehouse redirect to legacy" },
  ...
  },
  {
    ...
    features: [
      ...
      { id: "ql-amend", name: "Amend quote", legacy: "Enquiry DB", react: "/enquiries", status: "partial", testHint: "Amend on desk for air/sea/courier" },
  ...
  },
  {
    ...
    plannedPhase: 12,
    features: [
      { id: "nrs-convert", name: "NRS convert flow (shipper/consignee capture)", legacy: "NRS desk", status: "partial" },
  ...
  },
  {
    ...
    features: [
      ...
      { id: "pwa", name: "PWA manifest + service worker", legacy: "Global", status: "partial" },
    ],
  },
];
