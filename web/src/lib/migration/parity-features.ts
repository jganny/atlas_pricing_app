...
export const parityGroups: ParityGroup[] = [
  {
    ...
    features: [
      ...
      { id: "auth-signup", name: "Self-service sign up", legacy: "Login page", react: "/login", status: "done", testHint: "Sign up creates Auth user + queues admin role" },
      { id: "auth-forgot", name: "Forgot / change password", legacy: "Login + admin", react: "/login + /admin", status: "done", testHint: "Forgot form + admin reset queue" },
      { id: "auth-admin-register", name: "Admin register new user", legacy: "Admin console", react: "/admin", status: "done", testHint: "Queue registration + pending list" },
      { id: "auth-admin-reset", name: "Force password reset", legacy: "Admin console", react: "/admin", status: "done", testHint: "Reset queue mark done / dismiss" },
      ...
      { id: "auth-firebase-config", name: "Firebase config paste / reconnect", legacy: "Admin console", react: "/admin", status: "done", testHint: "Paste JSON → save & reload; Maps key optional" },
    ],
  },
  {
    id: "home-manager",
    ...
    features: [
      ...
      { id: "home-reports", name: "Performance report generator (daily→annual)", legacy: "Overview", react: "/", status: "done", testHint: "Period + officer filter, CSV/print" },
  ...
  },
  {
    ...
    features: [
      ...
      { id: "member-nrs-alerts", name: "NRS confirmation intimation alerts", legacy: "Member dashboard", react: "/", status: "done", testHint: "Won on nomination desk pushes dismissible alerts" },
      ...
      { id: "member-sms", name: "Instant SMS gateway", legacy: "Member dashboard", react: "/", status: "done", testHint: "sms: deep-link + optional webhook + outbox" },
  ...
  },
  {
    ...
    features: [
      ...
      { id: "air-agreement", name: "Agency agreement upload & compliance", legacy: "Air desk", react: "/air + /directory", status: "done", testHint: "PDF attach on Terms for nomination desks" },
      { id: "air-role-defaults", name: "Role-based currency, terms, surcharge visibility", legacy: "Air desk", react: "/air", status: "done" },
      { id: "air-smart-embed", name: "New-job intake is Quote hub Drop the job (not a paste strip on the desk)", legacy: "Air desk", react: "/quote", status: "done", testHint: "Paste on Quote hub — Air desk has no Paste enquiry strip" },
      ...
      { id: "air-maps", name: "Google Maps airport embed", legacy: "Air desk", react: "/air", status: "done", testHint: "Embed when Maps key set; else external link" },
  ...
  },
  {
    ...
    features: [
      ...
      { id: "sea-smart-embed", name: "New-job intake is Quote hub Drop the job (not a paste strip on the desk)", legacy: "Sea desk", react: "/quote", status: "done", testHint: "Paste on Quote hub — Sea desk has no Paste enquiry strip" },
  ...
  },
  {
    ...
    features: [
      ...
      { id: "edb-reports", name: "Financial reports + CSV export", legacy: "Enquiry DB", react: "/enquiries", status: "done", testHint: "CSV + FY Q1–Q4/YTD cards" },
      { id: "edb-archive", name: "90-day archive + find old quote", legacy: "Enquiry DB", react: "/enquiries", status: "done", testHint: "Lookup + admin Run 90-day archive" },
  ...
  },
  {
    ...
    features: [
      ...
      { id: "hr-module", name: "HR module shell", legacy: "HR", react: "/hr", status: "done", testHint: "Roster + leave log + notes" },
    ],
  },
  {
    id: "nrs-roles",
  ...
  },
  {
    ...
    features: [
      ...
      { id: "pwa", name: "PWA manifest + service worker", legacy: "Global", react: "manifest + sw.js", status: "done", testHint: "Manifest + shell SW registration" },
    ],
  },
];
