...
export const innovationItems: InnovationItem[] = [
  ...
  { id: "i2-live-tariffs", name: "Live tariff/circular sync", phase: 2, status: "done", why: "Circulars + tariffs load live; Excel publish path shipped", react: "/circulars" },
  ...
  { id: "i3-audit", name: "Calc audit trail in quotes", phase: 3, status: "done", why: "SAP-style step log on save", react: "calc-audit" },
  ...
  { id: "i4-zod", name: "Zod + React Hook Form", phase: 4, status: "done", why: "Desk shipment schemas + validation", react: "Desks (Zod schemas)" },
  ...
  { id: "i5-tariff-ai", name: "Tariff intelligence hints", phase: 5, status: "done", why: "Lane Circulars coverage tips on desks", react: "TariffIntelHint" },
  ...
  { id: "i6-optimistic", name: "Optimistic status updates", phase: 6, status: "done", why: "Instant lost/cancel/delete feel", react: "Inspector" },

  { id: "i7-shadcn", name: "shadcn/ui + Radix", phase: 7, status: "done", why: "Accessible enterprise primitives", react: "ui.tsx" },
  { id: "i7-pdf", name: "React PDF quotations", phase: 7, status: "done", why: "Letterhead preview + Print/Save PDF", react: "QuotePreviewModal" },
  ...
  { id: "i11-rbac", name: "Role-based UI (RBAC)", phase: 11, status: "done", why: "Nav + soft route guard by desk login", react: "AppShell + RouteGuard" },
  { id: "i11-directory", name: "Directory CRM", phase: 11, status: "done", why: "Agents/Vendors grid + search + CRUD + CSV", react: "/directory" },
  { id: "i11-ai", name: "AI Smart Inbox", phase: 11, status: "done", why: "Inbox re-parse + desk apply; IMAP poller optional", react: "/inbox" },
  ...
  { id: "i14-sentry", name: "Sentry monitoring", phase: 14, status: "done", why: "Optional DSN hook via NEXT_PUBLIC_SENTRY_DSN", react: "lib/monitoring/sentry" },
  { id: "i14-e2e", name: "Playwright E2E", phase: 14, status: "done", why: "Smoke specs for login + parity", react: "web/e2e/smoke.spec.ts" },
  ...
  { id: "i16-quote-share", name: "Fast print + client quote file (email / WhatsApp / download)", phase: 16, status: "done", why: "Print uses an isolated HTML document so Enquiry DB chrome is not laid out. Shared HTML lets the client tap each airline; PDF lists every option on paper.", react: "quote-document + QuotePreviewModal" },
];
