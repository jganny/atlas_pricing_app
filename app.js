...
function loadSavedQuotes() {
  ...
  if (saved) {
    ...
    // Generate a beautiful, extensive set of historical data spanning different dates of 2026.
    const mockQuotes = [
      // TODAY (July 9, 2026)
      {
        id: "q901",
        date: "2026-07-09",
        type: "air",
        customer: "Zenith Electronics Inc.",
        route: "BOM → JFK via EK",
        amount: 3250.00,
        amountINR: 271375,
        currency: "USD",
        creator: "air-nom",
        status: "converted",
        conversionDate: "2026-07-09",
        details: { chargeableWeight: 350.00, rate: 8.50, freightTotal: 2975.00, surchargeTotal: 275.00 }
      },
      {
        id: "q902",
        date: "2026-07-09",
        ...
        route: "INNSA → NLRTM (FCL)",
        amount: 2875.00,
        amountINR: 240062.50,
        currency: "USD",
        creator: "sea-nom",
        status: "quoted",
        details: { mode: "fcl", baseFreight: 2600.00, surchargeTotal: 275.00 }
      },
      // JULY 2026
      {
        id: "q701",
        ...
        route: "DEL → LHR via BA",
        amount: 145000.00,
        amountINR: 145000.00,
        currency: "INR",
        creator: "air-local",
        status: "converted",
        conversionDate: "2026-07-05",
        details: { chargeableWeight: 450.00, rate: 300, freightTotal: 135000.00, surchargeTotal: 10000.00 }
      },
      {
        id: "q702",
        date: "2026-07-04",
        ...
        route: "INNSA → AEDXB (FCL) via MSC",
        amount: 185000.00,
        amountINR: 185000.00,
        currency: "INR",
        creator: "sea-local",
        status: "quoted",
        details: { mode: "fcl", baseFreight: 160000.00, surchargeTotal: 25000.00 }
      },
      // JUNE 2026 (Q2)
      {
        id: "q601",
        ...
        route: "BOM → SIN via SQ",
        amount: 4200.00,
        amountINR: 350700.00,
        currency: "USD",
        creator: "air-nom",
        status: "converted",
        conversionDate: "2026-06-16",
        details: { chargeableWeight: 600.00, rate: 6.50, freightTotal: 3900.00, surchargeTotal: 300.00 }
      },
      {
        id: "q602",
        date: "2026-06-20",
        type: "sea",
        customer: "Reliance Retail",
        route: "INNSA → SGPIN (LCL)",
        amount: 1250.00,
        amountINR: 104375.00,
        currency: "USD",
        creator: "sea-nom",
        status: "quoted",
        details: { mode: "lcl", baseFreight: 950.00, surchargeTotal: 300.00 }
      },
      {
        id: "q603",
        date: "2026-06-25",
        ...
        route: "BLR → BOM via 6E",
        amount: 85000.00,
        amountINR: 85000.00,
        currency: "INR",
        creator: "air-local",
        status: "converted",
        conversionDate: "2026-06-26",
        details: { chargeableWeight: 250.00, rate: 320, freightTotal: 80000.00, surchargeTotal: 5000.00 }
      },
      // MAY 2026 (Q2)
      {
        id: "q501",
        ...
        details: { mode: "fcl", baseFreight: 5100.00, surchargeTotal: 300.00 }
      },
      {
        id: "q502",
        date: "2026-05-18",
        ...
        route: "BOM → FRA via LH",
        amount: 12000.00,
        amountINR: 1002000.00,
        currency: "USD",
        creator: "air-nom",
        status: "quoted",
        details: { chargeableWeight: 1500.00, rate: 7.50, freightTotal: 11250.00, surchargeTotal: 750.00 }
      },
      {
        id: "q503",
        date: "2026-05-24",
        type: "sea",
        customer: "Chennai Exporters Ltd",
        route: "INMAA → LKCMB (LCL)",
        amount: 45000.00,
        amountINR: 45000.00,
        currency: "INR",
        creator: "sea-local",
        status: "converted",
        conversionDate: "2026-05-25",
        details: { mode: "lcl", baseFreight: 38000.00, surchargeTotal: 7000.00 }
      },
      // APRIL 2026 (Q2)
      {
        id: "q401",
        date: "2026-04-12",
        type: "air",
        customer: "Dr Reddy Labs",
        route: "HYD → JFK via QR",
        amount: 8600.00,
        amountINR: 718100.00,
        currency: "USD",
        creator: "air-nom",
        ...
        details: { chargeableWeight: 900.00, rate: 8.80, freightTotal: 7920.00, surchargeTotal: 680.00 }
      },
      {
        id: "q402",
        date: "2026-04-25",
        ...
        route: "INNSA → DEHAM (FCL)",
        amount: 3200.00,
        amountINR: 267200.00,
        currency: "USD",
        creator: "sea-nom",
        status: "quoted",
        details: { mode: "fcl", baseFreight: 2900.00, surchargeTotal: 300.00 }
      },
      // MARCH 2026 (Q1)
      {
        id: "q301",
        ...
        details: { chargeableWeight: 2400.00, rate: 280, freightTotal: 672000.00, surchargeTotal: 48000.00 }
      },
      {
        id: "q302",
        date: "2026-03-18",
        ...
        route: "INNSA → SGPIN (FCL)",
        amount: 1450.00,
        amountINR: 121075.00,
        currency: "USD",
        creator: "sea-nom",
        status: "converted",
        conversionDate: "2026-03-19",
        details: { mode: "fcl", baseFreight: 1250.00, surchargeTotal: 200.00 }
      },
      // FEBRUARY 2026 (Q1)
      {
        id: "q201",
        date: "2026-02-12",
        type: "air",
        customer: "Cipla Biotech",
        route: "BOM → LHR via EK",
        amount: 6800.00,
        amountINR: 567800.00,
        currency: "USD",
        creator: "air-nom",
        status: "converted",
        conversionDate: "2026-02-13",
        details: { chargeableWeight: 800.00, rate: 7.80, freightTotal: 6240.00, surchargeTotal: 560.00 }
      },
      {
        id: "q202",
        date: "2026-02-28",
        ...
        creator: "sea-local",
        status: "quoted",
        details: { mode: "fcl", baseFreight: 250000.00, surchargeTotal: 25000.00 }
      },
      // JANUARY 2026 (Q1)
      {
        id: "q101",
        date: "2026-01-10",
        type: "air",
        customer: "Biocon Pharmaceuticals",
        route: "BLR → JFK via SQ",
        amount: 14500.00,
        amountINR: 1210750.00,
        currency: "USD",
        creator: "air-nom",
        status: "converted",
        conversionDate: "2026-01-12",
        details: { chargeableWeight: 1500.00, rate: 9.00, freightTotal: 13500.00, surchargeTotal: 1000.00 }
      },
      {
        id: "q102",
        date: "2026-01-20",
        type: "sea",
        customer: "Kolkata Tea Exporters",
        route: "INNSA → GBFXT (LCL)",
        amount: 850.00,
        amountINR: 70975.00,
        currency: "USD",
        creator: "sea-nom",
        status: "quoted",
        details: { mode: "lcl", baseFreight: 650.00, surchargeTotal: 200.00 }
      }
    ];
    appState.quotes = mockQuotes;
    localStorage.setItem("logistics_quotes", JSON.stringify(mockQuotes));
  }

  // Map legacy creator IDs to Shashank, Mahendra, and Jaya
  const creatorMap = {
    'air-nom': 'shashank',
    'sea-nom': 'mahendra',
    'air-local': 'jaya',
